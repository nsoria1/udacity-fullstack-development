...
class webServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        try:
            ...
            # Objetive 4 - Edit existent Restaurants
            if self.path.endswith("/edit"):
                ...
                if myRestaurantQuery:
                    ...
                    output = ""
                    output += "<html><body>"
                    output += "<h2>This is the restaurant you've selected:</h2>"
            ...
            # Objetive 5 - Delete existent Restaurants
        ...
        try:
            ...
            if self.path.endswith("/edit"):
                ...
                if ctype == 'multipart/form-data':
                    ...
                    restaurantIDPath = self.path.split("/")[2]
                    editRestaurant = session.query(Restaurant).filter_by(id=restaurantIDPath).one()
                    if editRestaurant != []:
